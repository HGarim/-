...
// Servo adjustment
#define _DUTY_MAX 2443  // Servo angle: D degree
#define _DUTY_NEU 1941  // Servo angle: 0 degree
#define _DUTY_MIN 1279   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 91 // Replace with |D - E| degree
#define _SERVO_SPEED 1000 // servo speed limit (unit: degree/second)

#define _BANGBANG_RANGE 500
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 1260 - 6.88*a_value + 0.0133*a_value*a_value -8.79E-06*a_value*a_value*a_value;
}
