...
void loop() {
  ...
  if ((distance > _DIST_MIN) && (distance <= 200)) {
    brightness = 255 - (distance - 100) * (distance-100) * 0.0255;
    analogWrite(PIN_LED, brightness);
  } else if ((distance < _DIST_MAX) && (distance > 200)) {
    brightness = 255 - (distance - 300) * (distance - 300) * 0.0255;
    analogWrite(PIN_LED, brightness);
  } else {
