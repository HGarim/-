...
void loop() {
  ...
  else if (distance > _DIST_MAX) { distance = _DIST_MAX; }

  if (distance <=200) { brightness = 255 - (distance - 100) * (distance-100) * 0.0255; } 
  else if (distance > 200) { brightness = 255 - (distance - 300) * (distance - 300) * 0.0255; }
